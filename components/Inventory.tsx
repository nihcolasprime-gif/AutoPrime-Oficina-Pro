                            ...
                            <tr key={part.id} className="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td className="p-5">
                                    <div className="flex flex-col items-center gap-1">
                                        ...
                                        <span className={`text-[10px] mt-1 ${isLow ? 'text-red-600 font-bold' : 'text-slate-400'}`}>
                                ...
                                <td className="p-5 text-right">
                                    <div className="flex justify-center gap-2">
                                        <button 
                                            ...
                                            className="p-2 text-slate-500 hover:text-brand-600 hover:bg-white border border-transparent hover:border-slate-200 hover:shadow-sm rounded-lg transition-all"
                                            title="Editar"
                                        >
                                            <Edit2 size={18} />
                                        </button>
                                        <button 
                                            ...
                                            className="p-2 text-slate-500 hover:text-red-600 hover:bg-white border border-transparent hover:border-slate-200 hover:shadow-sm rounded-lg transition-all"
                                            title="Excluir"
                                        >
                                            <Trash2 size={18} />
                                        </button>
